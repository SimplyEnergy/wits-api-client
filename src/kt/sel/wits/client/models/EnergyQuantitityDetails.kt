...
import sel.wits.client.models.BaseQuantityDetails
import sel.wits.client.models.EnergyQuantitityDetailsAllOf
 ...
 * @param load 
 * @param generation 
 * @param windGeneration 
 * @param totalBids 
 * @param totalOffers 
 * @param windOffers 
 */

data class EnergyQuantitityDetails (

    @Json(name = "tradingDateTime")
    val tradingDateTime: kotlin.String,

    /* A sequential 30-minute period starting from period 1 at midnight (00:00) and, on most days, ending at period 48 at 23:30.  The exceptions to this are on the spring and autumn daylight-time changeover days. The spring change-over day is 23 hours long (as the clock jumps forward from 2am to 3am) so only has 46 trading-periods and the autumn change-over day is 25 hours long (as the clock jumps back from 3am to 2am) and has 50 trading-periods. */
    @Json(name = "tradingPeriod")
    val tradingPeriod: kotlin.Int,
    ...
    @Json(name = "load")
    val load: java.math.BigDecimal? = null,

    @Json(name = "generation")
    val generation: java.math.BigDecimal? = null,

    @Json(name = "windGeneration")
    val windGeneration: java.math.BigDecimal? = null,

    @Json(name = "totalBids")
    val totalBids: java.math.BigDecimal? = null,

    @Json(name = "totalOffers")
    val totalOffers: java.math.BigDecimal? = null,

    @Json(name = "windOffers")
    val windOffers: java.math.BigDecimal? = null
