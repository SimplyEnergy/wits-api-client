 ...
 * 
 *
 * Values: INSTANTANEOUS_RESERVE,RESERVE_OFFERS,ADJUSTED_RESERVE_OFFERS
 */

enum class RunClass(val value: kotlin.String) {

    @Json(name = "InstantaneousReserve")
    INSTANTANEOUS_RESERVE("InstantaneousReserve"),

    @Json(name = "ReserveOffers")
    RESERVE_OFFERS("ReserveOffers"),

    @Json(name = "AdjustedReserveOffers")
    ADJUSTED_RESERVE_OFFERS("AdjustedReserveOffers");
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is RunClass) "$data" else null

        /**
         * Returns a valid [RunClass] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): RunClass? = data?.let {
