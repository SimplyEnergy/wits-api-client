...
import sel.wits.client.models.EnergyQuantitityDetails
 ...
 *
 * @param schedule 
 * @param energyQuantities 
 */

data class EnergyScheduleDetails (

    @Json(name = "schedule")
    val schedule: kotlin.String,

    @Json(name = "energyQuantities")
    val energyQuantities: kotlin.collections.List<EnergyQuantitityDetails>
