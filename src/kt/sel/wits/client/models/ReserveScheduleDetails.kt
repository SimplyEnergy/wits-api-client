...
import sel.wits.client.models.ReserveQuantitityDetails
 ...
 *
 * @param schedule 
 * @param reserveQuantities 
 */

data class ReserveScheduleDetails (

    @Json(name = "schedule")
    val schedule: kotlin.String,

    @Json(name = "reserveQuantities")
    val reserveQuantities: kotlin.collections.List<ReserveQuantitityDetails>? = null
