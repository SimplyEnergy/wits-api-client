...
enum class Island(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is Island) "$data" else null

        /**
         * Returns a valid [Island] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): Island? = data?.let {
