...
import sel.wits.client.models.GetEnergyQuantitiesResponse
...
class EnergyApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath) {
    companion object {
        @JvmStatic
     ...
     * @return GetEnergyQuantitiesResponse
    ...
    fun energyGet(schedules: kotlin.collections.List<kotlin.String>, from: kotlin.String? = null, to: kotlin.String? = null, back: kotlin.Int? = null, forward: kotlin.Int? = null, island: Island? = null) : GetEnergyQuantitiesResponse {
        val localVarResponse = energyGetWithHttpInfo(schedules = schedules, from = from, to = to, back = back, forward = forward, island = island)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as GetEnergyQuantitiesResponse
     ...
     * @param forward Optional trading period filter (optional)
     * @param island Return quantity data only for the selected island (optional)
     * @return ApiResponse<GetEnergyQuantitiesResponse?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun energyGetWithHttpInfo(schedules: kotlin.collections.List<kotlin.String>, from: kotlin.String?, to: kotlin.String?, back: kotlin.Int?, forward: kotlin.Int?, island: Island?) : ApiResponse<GetEnergyQuantitiesResponse?> {
        val localVariableConfig = energyGetRequestConfig(schedules = schedules, from = from, to = to, back = back, forward = forward, island = island)

        return request<Unit, GetEnergyQuantitiesResponse>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation energyGet
     *
     * @param schedules 
     * @param from Optional trading date-time to filter historical data (optional)
     * @param to Optional trading date-time to filter historical data (optional)
     ...
     */
    fun energyGetRequestConfig(schedules: kotlin.collections.List<kotlin.String>, from: kotlin.String?, to: kotlin.String?, back: kotlin.Int?, forward: kotlin.Int?, island: Island?) : RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun schedulesScheduleEnergyGet(schedule: kotlin.String, from: kotlin.String? = null, to: kotlin.String? = null, back: kotlin.Int? = null, forward: kotlin.Int? = null, island: Island? = null) : EnergyScheduleDetails {
        val localVarResponse = schedulesScheduleEnergyGetWithHttpInfo(schedule = schedule, from = from, to = to, back = back, forward = forward, island = island)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as EnergyScheduleDetails
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
     ...
     * @param forward Optional trading period filter (optional)
     * @param island Return quantity data only for the selected island (optional)
     * @return ApiResponse<EnergyScheduleDetails?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun schedulesScheduleEnergyGetWithHttpInfo(schedule: kotlin.String, from: kotlin.String?, to: kotlin.String?, back: kotlin.Int?, forward: kotlin.Int?, island: Island?) : ApiResponse<EnergyScheduleDetails?> {
        val localVariableConfig = schedulesScheduleEnergyGetRequestConfig(schedule = schedule, from = from, to = to, back = back, forward = forward, island = island)

        return request<Unit, EnergyScheduleDetails>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation schedulesScheduleEnergyGet
     *
     * @param schedule 
     * @param from Optional trading date-time to filter historical data (optional)
     * @param to Optional trading date-time to filter historical data (optional)
     ...
     * @return RequestConfig
     */
    fun schedulesScheduleEnergyGetRequestConfig(schedule: kotlin.String, from: kotlin.String?, to: kotlin.String?, back: kotlin.Int?, forward: kotlin.Int?, island: Island?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (from != null) {
        ...
        return RequestConfig(
            method = RequestMethod.GET,
            path = "/schedules/{schedule}/energy".replace("{"+"schedule"+"}", "$schedule"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
